...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="assets/img/truck1.jpg" type="image/png">
    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#home" class="nav__logo"><img src="assets/img/truck1.jpg" alt="" class="app__store"></a>

                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="#home" class="nav__link active-link">Home</a></li>
                        <li class="nav__item"><a href="#menu" class="nav__link">Brands</a></li>
                        <li class="nav__item"><a href="#services" class="nav__link">Services</a></li>
                        <li class="nav__item"><a href="#about" class="nav__link">About Us</a></li>
                        <li class="nav__item"><a href="#contact" class="nav__link">Contact Coke</a></li>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Cola Cool Experience</h1>
                        <h2 class="home__subtitle">Refreshing<br> moments!...</h2>
                        <a href="#" class="button">View Coke Products</a>
                    </div>
    
                    <img src="assets/img/spin290x300.png" alt="" class="home__img">
                </div>
            </section>
             ...
             <section class="menu section bd-container" id="menu">
                ...
                <h2 class="section-title">Daily Refreshment Brands</h2>


                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="assets/img/coke2.png" alt="" class="menu__img">
                        <h3 class="menu__name">Coke</h3>
                        <span class="menu__detail">300ml</span>
                        <span class="menu__preci">$0.8</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/coke.png" alt="" class="menu__img">
                        <h3 class="menu__name">Coke Original Taste</h3>
                        <span class="menu__detail">300ml</span>
                        <span class="menu__preci">$0.8</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    ...
                    <div class="menu__content">
                        <img src="assets/img/coke3.png" alt="" class="menu__img">
                        <h3 class="menu__name">Coke</h3>
                        <span class="menu__detail">300ml</span>
                        <span class="menu__preci">$0.8</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                        ...
                        <div class="menu__content">
                            <img src="assets/img/coke.png" alt="" class="menu__img">
                            <h3 class="menu__name">Coke Original</h3>
                            <span class="menu__detail">300ml</span>
                            <span class="menu__preci">$0.8</span>
                            <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                        </div>
            ...
            <section class="services section bd-container" id="services">
                <span class="section-subtitle">Coca-Cola Offers</span>
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Excellent Drink Brands</h3>
                        <p class="services__description">The Coca‑Cola Company’s purpose is to refresh the world and make a difference and we have remained true to that purpose for 137 years..</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Drinks Availablity</h3>
                        <p class="services__description">Our strategy is centered around people—our consumers and employees—and driving sustainable solutions that build resilience into our business.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <p class="services__description">The home delivery service, coupled with our wide national reach through our distributors, will ensure delivery of orders across the country.</p>
                    </div>
                </div>
            </section>
            <!--========== ABOUT ==========-->
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        <span class="section-subtitle about__initial">About Coca-Cola</span>
                        <h2 class="section-title about__initial">Fun fun<br> time!</h2>
                        <p class="about__description">We continued to build a portfolio of loved beverage brands while building a more sustainable future for our business, communities and planet. We have an opportunity to use our scale to address global challenges and create a force for good.</p>
                        <a href="#" class="button">Explore history</a>
                    </div>

                    <img src="assets/img/coce-fun.png" alt="" class="about__img">
                </div>
            </section>
            ...
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    <div class="app__data">
                        <span class="section-subtitle app__initial">Available on Playstore!</span>
                        <h2 class="section-title app__initial">Collect, Play & Enter on Cola-Cola App for your chance to win awesome prices</h2>
                        <p class="app__description">Enjoy our refreshing beverages, collect special App currencies, play games and enter our promotions, it's both fun and rewarding.</p>
                        <div class="app__stores">
                            <a href="https://play.google.com/store/apps/details?id=com.coca_cola.android.cep&hl=en_US&gl=US"><img src="assets/img/app2.png" alt="" class="app__store"></a>
                            <a href="https://apps.apple.com/gb/app/coca-cola/id1451072799?source_caller=ui&shortlink=mbcsvejy&c=ONE%20Site%20App%20Download&pid=ONE%20site&action=home&af_channel=ONE%20site"><img src="assets/img/app1.png" alt="" class="app__store"></a>
                        </div>
                    </div>

                    <img src="assets/img/play_store.png" alt="" class="app__img">
                </div>
            </section>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <p class="contact__description">Want to get in touch with Cola? Here you'll find all the relevant points of contact for every type of enquiry, with our 24/7 chat service.</p>
                    </div>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Drinks</a>
                    <span class="footer__description">Brands</span>
                    <div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li><a href="#" class="footer__link">Cola Delivery</a></li>
                        <li><a href="#" class="footer__link">Cola Pricing</a></li>
                        <li><a href="#" class="footer__link">Events</a></li>
                        <li><a href="#" class="footer__link">Reserves</a></li>
                    </ul>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li><a href="#" class="footer__link">Organized Cola Events</a></li>
                        <li><a href="#" class="footer__link">Contact us</a></li>
                        <li><a href="#" class="footer__link">Privacy Statement</a></li>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li>Jr Union #999</li>
                        <li>000 - 444 - 770</li>
                        <li>coca.cola@uk.ac</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; 2023 UK Coca-Cola Comapany. All Rights Reserved</p>
        </footer>
